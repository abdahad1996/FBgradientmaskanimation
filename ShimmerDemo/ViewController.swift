...
//        setupShimmeringImage()
    ...
    //first add darkbackgorund image and den add white background image
    // add gradient with clear first den black and den white repeat infinite times
    // rotate -60 degrees from z axix
